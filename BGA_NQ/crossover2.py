...
def crossover2(pop, nvar, ncross):
    ...
    for n in range(0, ncross, 2):
        ...
        j1 = random.randrange(nvar - 2)
        j2 = random.randrange(j1+1, nvar - 1)
        o1 = np.concatenate((p1[:j1+1], p2[j1+1:j2+1], p1[j2+1:]))
        o2 = np.concatenate((p2[:j1+1], p1[j1+1:j2+1], p2[j2+1:]))
...
if __name__ == '__main__':
    ...
    print(pop.pos)
    print(crossover2(pop, nvar, ncross).pos)
